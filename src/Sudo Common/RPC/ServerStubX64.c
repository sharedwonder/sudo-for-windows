...
extern const MIDL_SERVER_INFO SudoForWindows_ServerInfo;

extern const RPC_DISPATCH_TABLE SudoForWindows_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE SudoForWindows___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0x479faa79,0x6f61,0x1499,{0x50,0x6f,0xb4,0xa5,0x4c,0x73,0xf9,0x6f}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&SudoForWindows_v1_0_DispatchTable,
    0,
    0,
    0,
    &SudoForWindows_ServerInfo,
    0x06000000
    };
RPC_IF_HANDLE SudoForWindows_v1_0_s_ifspec = (RPC_IF_HANDLE)& SudoForWindows___RpcServerInterface;
...
static const RPC_DISPATCH_FUNCTION SudoForWindows_table[] =
    {
    NdrServerCall2,
    0
    };
static const RPC_DISPATCH_TABLE SudoForWindows_v1_0_DispatchTable = 
    {
    1,
    (RPC_DISPATCH_FUNCTION*)SudoForWindows_table
    };
...
static const MIDL_STUB_DESC SudoForWindows_StubDesc = 
    {
    (void *)& SudoForWindows___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& SudoForWindows_ServerInfo,   /* proxy/server info */
    0
    };

static const RPC_DISPATCH_FUNCTION SudoForWindows_NDR64__table[] =
    {
    NdrServerCallAll,
    0
    };
static const RPC_DISPATCH_TABLE SudoForWindows_NDR64__v1_0_DispatchTable = 
    {
    1,
    (RPC_DISPATCH_FUNCTION*)SudoForWindows_NDR64__table
    };
...
static const MIDL_SYNTAX_INFO SudoForWindows_SyntaxInfo [  2 ] = 
    ...
    ,{
    {{0x71710533,0xbeba,0x4937,{0x83,0x19,0xb5,0xdb,0xef,0x9c,0xcc,0x36}},{1,0}},
    (RPC_DISPATCH_TABLE*)&SudoForWindows_NDR64__v1_0_DispatchTable,
    0 ,
...
static const SERVER_ROUTINE SudoForWindows_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)LaunchElevatedProcess
    };

static const MIDL_SERVER_INFO SudoForWindows_ServerInfo = 
    {
    &SudoForWindows_StubDesc,
    SudoForWindows_ServerRoutineTable,
    SudoService__MIDL_ProcFormatString.Format,
    (unsigned short *) SudoForWindows_FormatStringOffsetTable,
    0,
